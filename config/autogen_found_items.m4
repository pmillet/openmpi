...
dnl
dnl Generated by pxps at Wed Jun  7 15:19:09 2017
dnl on pxps.
dnl ---------------------------------------------------------------------------
...
m4_define([mca_opal_common_m4_config_component_list], [sm, verbs_usnic, cuda, ugni, libfabric, verbs])
...
m4_define([mca_opal_btl_m4_config_component_list], [sm, portals4, scif, usnic, vader, ugni, openib, tcp, smcuda])
...
m4_define([mca_opal_memory_m4_config_component_list], [patcher, malloc_solaris])
...
m4_define([mca_opal_pmix_m4_config_component_list], [external, pmix112, s2, cray, s1])
...
m4_define([mca_opal_rcache_m4_config_component_list], [udreg, gpusm, rgpusm])
...
m4_define([mca_opal_shmem_m4_config_component_list], [posix, mmap, sysv])
...
m4_define([mca_orte_errmgr_no_config_component_list], [default_app, default_orted, default_tool, default_hnp])

dnl Components in the orte / ess framework
m4_define([mca_orte_ess_m4_config_component_list], [lsf, tm, alps, slurm])
m4_define([mca_orte_ess_no_config_component_list], [tool, singleton, env, pmi, hnp])
...
m4_define([mca_orte_iof_no_config_component_list], [tool, mr_orted, orted, mr_hnp, hnp])
...
m4_define([mca_orte_oob_m4_config_component_list], [ud, alps, tcp, usock])
m4_define([mca_orte_oob_no_config_component_list], [])

dnl Components in the orte / plm framework
m4_define([mca_orte_plm_m4_config_component_list], [isolated, lsf, tm, alps, rsh, slurm])
m4_define([mca_orte_plm_no_config_component_list], [])

dnl Components in the orte / ras framework
m4_define([mca_orte_ras_m4_config_component_list], [lsf, tm, gridengine, alps, loadleveler, slurm])
...
m4_define([mca_orte_rmaps_no_config_component_list], [seq, staged, round_robin, mindist, resilient, rank_file, ppr])
...
m4_define([mca_orte_routed_no_config_component_list], [radix, binomial, debruijn, direct])
...
m4_define([mca_orte_state_no_config_component_list], [novm, app, staged_orted, tool, orted, dvm, staged_hnp, hnp])
...
m4_define([mca_ompi_coll_m4_config_component_list], [portals4, cuda, hcoll, fca])
m4_define([mca_ompi_coll_no_config_component_list], [sm, tuned, sync, inter, basic, self, libnbc])
...
m4_define([mca_ompi_fcoll_no_config_component_list], [individual, dynamic_gen2, two_phase, dynamic, static])
...
m4_define([mca_ompi_mtl_m4_config_component_list], [portals4, ofi, mxm, psm, psm2])
...
m4_define([mca_ompi_pml_m4_config_component_list], [v, ucx, ob1, yalla])
...
m4_define([ompi_mpiext_list], [affinity, cuda, cr])
